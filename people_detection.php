<?php
// File: people_detection.php
function detectMovingPeople($files, $cfg, $tempDir) {
    ensureDir($tempDir);
    $segs = [];
    foreach ($files as $file) {
        $dur = floatval(shell_exec("ffprobe -v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 ".escapeshellarg($file)));
